...
import { LiveChannelsPanelComponent } from '../../shared/live-channels-panel/live-channels-panel.component';
...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, RouterLinkActive, LiveChannelsPanelComponent],
  template: `
